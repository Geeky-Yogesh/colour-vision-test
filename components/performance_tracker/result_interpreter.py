"""
Result Interpreter Module - Fixed version with correct dictionary keys
"""
...
class ResultInterpreter:
    ...
    ISHIHARA_THRESHOLDS = {
        ...
        'mild': {'min': 60, 'max': 84, 'color': 'orange', 'icon': ''},
    ...
    def show_interpretation_result(interpretation: Dict[str, Any]):
        ...
        if 'interpretation' in interpretation:
            ...
            message = interpretation.get('message', 'No interpretation available')
